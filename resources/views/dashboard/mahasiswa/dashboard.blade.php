            ...
            <div class="col-lg-12">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-4">
                        @include('dashboard.mahasiswa._dashboard._notifikasi-tugas')
                    </div>

                    <div class="col-lg-6 mb-4">
                        @include('dashboard.mahasiswa._dashboard._jadwal-hari-ini')
                        <div class="mt-4">
                            @include('dashboard.mahasiswa._dashboard._notifikasi-ujian')
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5 mb-4">
                        @include('dashboard.mahasiswa._dashboard._table-riwayat-ujian')
                    </div>
                    <div class="col-lg-7">
